...
resource "oci_objectstorage_object" "cf_stuff_state" {
  bucket    = oci_objectstorage_bucket.state.name
  namespace = data.oci_objectstorage_namespace.ns.namespace
  object    = "cf-infra.tfstate"
...
resource "oci_objectstorage_preauthrequest" "cf_stuff_state" {
  object_name  = oci_objectstorage_object.cf_infra_state.object
  access_type  = "ObjectReadWrite"
  bucket       = oci_objectstorage_bucket.state.name
  name         = "bootstrap"
...
# Remote state access
resource "oci_objectstorage_preauthrequest" "cf_infra_remote_state" {
  object_name  = oci_objectstorage_object.cf_infra_state.object
  access_type  = "ObjectReadWrite"
  bucket       = oci_objectstorage_bucket.state.name
  name         = "bootstrap"
